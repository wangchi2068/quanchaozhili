...
const cardJson = JSON.parse(readFileSync(resolve(root, "assets/campaigns/ants/card-ants.json"), "utf8"));
...
// 独立世界书
const loreJson = JSON.parse(readFileSync(resolve(root, "assets/campaigns/ants/worldbook.json"), "utf8"));
